...
export class InitialSchema1773579151562 implements MigrationInterface {
    name = 'InitialSchema1773579151562'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "menu" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "price" numeric(6,2) NOT NULL, "configuration" json NOT NULL, "availableFrom" character varying, "availableTo" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_51b63874cdce0d6898a0b2150f2" UNIQUE ("name"), CONSTRAINT "PK_35b2a8f47d153ff7a41860cceeb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_item_itemtype_enum" AS ENUM('product', 'menu')`);
        await queryRunner.query(`CREATE TABLE "order_item" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "unitPrice" numeric(10,2) NOT NULL, "totalPrice" numeric(10,2) NOT NULL, "itemType" "public"."order_item_itemtype_enum" NOT NULL DEFAULT 'product', "menuChoices" json, "customization" json, "specialInstructions" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "productId" integer, "menuId" integer, "orderId" integer, CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "orderNumber" character varying(50) NOT NULL, "type" "public"."order_type_enum" NOT NULL, "status" "public"."order_status_enum" NOT NULL DEFAULT 'PENDING', "paymentStatus" "public"."order_paymentstatus_enum" NOT NULL DEFAULT 'PENDING', "subtotal" numeric(10,2) NOT NULL, "deliveryFee" numeric(10,2) NOT NULL DEFAULT '0', "total" numeric(10,2) NOT NULL, "customerNote" text, "internalNote" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "completedAt" TIMESTAMP, "userId" integer, "deliveryAddressId" integer, "timeSlotId" integer, CONSTRAINT "UQ_4e9f8dd16ec084bca97b3262edb" UNIQUE ("orderNumber"), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bf50d4fdb33d6ffd352a8f89a1" ON "order" ("userId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_4e9f8dd16ec084bca97b3262ed" ON "order" ("orderNumber") `);
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "street" character varying(255) NOT NULL, "number" character varying(10) NOT NULL, "box" character varying(10), "postalCode" character varying(4) NOT NULL, "city" character varying(100) NOT NULL, "country" character varying(100) NOT NULL DEFAULT 'Belgium', "complement" character varying(255), "label" character varying(50), "isDefault" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "FK_5f91d6693d5aab198d418b9b1d0" FOREIGN KEY ("menuId") REFERENCES "menu"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bf50d4fdb33d6ffd352a8f89a1"`);
